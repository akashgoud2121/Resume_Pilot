...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert resume parser. Extract the following information from the resume. Return a JSON object with the following schema: {{{{toJson schema=outputSchema}}}}
